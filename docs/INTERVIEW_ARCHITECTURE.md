...
**Scale:** 67 endpoints · 18 tables · 26 migrations · 811 backend tests · 961 frontend
tests · 9,304 lines of Python under `app/` (raw `wc -l`, excluding tests, migrations and
