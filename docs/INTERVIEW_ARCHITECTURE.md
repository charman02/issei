...
**Scale:** 67 endpoints · 18 tables · 30 migrations · 983 backend tests · 1,031 frontend
tests · 10,946 lines of Python under `app/` (raw `wc -l`, excluding tests, migrations and
