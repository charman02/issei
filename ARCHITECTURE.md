...
- **Verifying changes:** backend has `pytest` (**519 tests** across `tests/`);
  frontend has Vitest + React Testing Library (**750 tests in 51 files**) — run
