...
- **Verifying changes:** backend has `pytest` (**579 tests** across `tests/`);
  frontend has Vitest + React Testing Library (**751 tests in 51 files**) — run
