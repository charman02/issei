...
- **Verifying changes:** backend has `pytest` (**462 tests** across `tests/`);
  frontend has Vitest + React Testing Library (**712 tests in 50 files**) — run
