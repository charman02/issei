...
As measured on this branch (see `README.md` for the method): **66 routes**, **18 models**,
**676 backend tests**, **933 frontend tests in 61 files**. Endpoint and test counts have
