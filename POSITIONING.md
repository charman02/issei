...
As measured on this branch (see `README.md` for the method): **64 routes**, **18 models**,
**579 backend tests**, **751 frontend tests in 51 files**. Endpoint and test counts have
