...
export default function Profile() {
  ...
  return (
    <div className="px-4 pt-8">
      <h1 className="font-serif text-2xl font-bold text-primary mb-6">Profile</h1>

      <div className="bg-surface rounded-xl p-5 shadow-sm mb-6">
        ...
        <p className="text-primary font-medium">{user.email || 'Unknown'}</p>
      </div>
